        ...
        if args.spec is not None:
            ...
            if args.num_experts:
                ...
                if use_te:
                    ...
                    if "moe_use_legacy_grouped_gemm" in inspect.signature(
                        get_gpt_layer_with_transformer_engine_spec
                    ).parameters:
                        layer_kwargs["moe_use_legacy_grouped_gemm"] = getattr(args, "moe_use_legacy_grouped_gemm", False)
                    transformer_layer_spec = get_gpt_layer_with_transformer_engine_spec(**layer_kwargs)
                else:
                    layer_kwargs = {
                        "num_experts": args.num_experts,
                        "moe_grouped_gemm": args.moe_grouped_gemm,
                    ...
                    if "moe_use_legacy_grouped_gemm" in inspect.signature(get_gpt_layer_local_spec).parameters:
                        layer_kwargs["moe_use_legacy_grouped_gemm"] = getattr(args, "moe_use_legacy_grouped_gemm", False)
                    transformer_layer_spec = get_gpt_layer_local_spec(**layer_kwargs)
