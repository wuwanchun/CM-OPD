...
source "/root/slime/scripts/models/${Model_name}.sh"


CKPT_ARGS=(
   --hf-checkpoint /work/CM-OPD/research-automation/slime-context-manager/models/${Model_name}/
   --ref-load /work/CM-OPD/research-automation/slime-context-manager/models/${Model_name}_torch_dist
   --load /work/CM-OPD/research-automation/slime-context-manager/models/${Model_name}_slime/
   --save /work/CM-OPD/research-automation/slime-context-manager/models/${Model_name}_slime/
   --save-interval 20
)

ROLLOUT_ARGS=(
   --prompt-data /work/CM-OPD/research-automation/slime-context-manager/data/dapo-math-17k/dapo-math-17k.jsonl
   --input-key prompt
   --apply-chat-template
   --rollout-shuffle
   --num-rollout 300
...
GRPO_ARGS=(
   ...
   --opd-teacher-load /work/CM-OPD/research-automation/slime-context-manager/models/${Model_name}_torch_dist      # Teacher model path
