"""Launch Slime training with rollout-built selection/review SFT samples."""
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default=str(ROOT / "checkpoints" / "selection_review_sft"))
    ...
    parser.add_argument("--selection-policy", default="rule_expand_omission")
    ...
    command = [
        ...
        "disclosure.slime_rollout.generate_selection_answer_review_rollout",
        "--rollout-shuffle",
        "--num-epoch",
        str(args.num_epoch),
        "--rollout-batch-size",
    ...
    print("Selection Review-SFT Slime command:")
